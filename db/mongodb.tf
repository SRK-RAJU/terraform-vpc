...
unzip -o mongodb.zip
cd mongodb-main
mongo --ssl --sslCAFile /home/roboshop/rds-combined-ca-bundle.pem --host ${aws_docdb_cluster.docdb.endpoint} --username admin1 --password roboshop1 < catalogue.js
mongo --ssl --sslCAFile /home/roboshop/rds-combined-ca-bundle.pem --host ${aws_docdb_cluster.docdb.endpoint} --username admin1 --password roboshop1 < users.js
EOF
  }
}
